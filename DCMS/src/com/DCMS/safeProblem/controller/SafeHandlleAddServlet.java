 ...
 * Description：
 */
@WebServlet("/safeHandle/add")
public class SafeHandlleAddServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Result add = safeHandleService.add(safeHandle);

        String s = JSON.toJSONString(add);
