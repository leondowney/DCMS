 ...
 * Author：jiangtao_liu
 * Date：2023/3/11
 * Description：饼图(by类型)servlet
 */
@WebServlet("/company/analysisType01")
public class CompanyAnalysisType01Servlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Result result = companyService.getAnalysisType01(cc);
